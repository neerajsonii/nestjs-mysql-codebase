        ...
        .html(function(d) {
            ...
            if (d.kind === 'module') {
                if (d.module) {
                    ...
                    if (d.name) {
                        _name +=
                            '<tspan x="0" dy="1.4em">' + d.name + '</tspan>';
                    }
                } else {
                    _name +=
                        '<tspan x="0" dy="1.4em">' +
                ...
                if (d.canActivate) {
                    _name +=
                        '<tspan x="0" dy="1.4em">&#10003; canActivate</tspan>';
                }
                if (d.canDeactivate) {
                    _name +=
                ...
                if (d.canActivateChild) {
                    _name +=
                        '<tspan x="0" dy="1.4em">&#10003; canActivateChild</tspan>';
                }
                if (d.canLoad) {
