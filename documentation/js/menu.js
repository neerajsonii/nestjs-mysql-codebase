document.addEventListener('DOMContentLoaded', function() {
        ...
        for (var i = 0; i < links.length; i++) {
            ...
            if (linkHref) {
                ...
                if (
                    ...
                    linkHref
                        .toLowerCase()
                        .indexOf(localContextInUrl.toLowerCase()) !== -1
                ) {
    ...
    setTimeout(function() {
        ...
        // collapse menu
        var classnameMenuToggler = document.getElementsByClassName(
                'menu-toggler'
            ),
        ...
        for (var i = 0; i < classnameMenuToggler.length; i++) {
            classnameMenuToggler[i].addEventListener(
                'click',
                toggleItemMenu,
                false
            );
            ...
            if (activeLink) {
                ...
                if (linkType === 'entity-link') {
                    ...
                    if (parentLi) {
                        ...
                        if (parentUl) {
                            ...
                            if (parentChapterMenu) {
                                var toggler = parentChapterMenu.querySelector(
                                        '.menu-toggler'
                                    ),
                    ...
                    if (linkContext && linkContext === 'sub-entity') {
                        ...
                        var linkContextId = activeLink.getAttribute(
                            'data-context-id'
                        );
                ...
                setTimeout(function() {
                    ...
                    if (
                        activeLink.innerHTML.toLowerCase().indexOf('readme') !=
                            -1 ||
