...
!(function(t, e) {
        ...
        var t = function(t, e) {
            ...
            n = function(t, e) {
                for (
                    ...
                    if ('.' === o && void 0 !== document.querySelector(e))
                        return t;
            ...
            i =
                ...
                function(i, a) {
                        ...
                        s = function(t) {
                            var e =
                                ...
                                i = /px/.test(e.marginBottom)
                                    ? Math.round(
                                          e.marginBottom.replace('px', '')
                                      )
                                    : 0,
                                a = /em/.test(e.marginTop)
                                    ? Math.round(
                                          e.marginTop.replace('em', '') *
                                              parseInt(e.fontSize)
                                      )
                                    : 0,
                                r = /em/.test(e.marginBottom)
                                    ? Math.round(
                                          e.marginBottom.replace('em', '') *
                                              parseInt(e.fontSize)
                                      )
                                    : 0;
                            return (
                    ...
                    (this.toggle = function(t) {
                        t.preventDefault(),
                            /\bin/.test(r.collapse.className)
                                ? r.close()
                                : r.open();
                    }),
                        (this.close = function() {
                            this._close(this.collapse),
                                t(this.btn, 'collapsed');
                        }),
                        (this.open = function() {
                            if (
                                ...
                                var t = this.accordion.querySelectorAll(
                                        '.collapse.in'
                                    ),
                                    o = t.length,
                                    n = 0;
                                for (n; n < o; n++)
                                    t[n] !== this.collapse && this._close(t[n]);
                            }
                        }),
                        ...
                        (this.getMaxHeight = function(t) {
                            for (
                                var e = 0, o = 0, n = t.children.length;
                                o < n;
                                o++
                            )
                                e += s(t.children[o]);
    ...
    for (
        var c = function(n, i) {
                (i = i || {}),
                    (this.tab =
                        'object' == typeof n ? n : document.querySelector(n)),
                ...
                (this.handle = function(o) {
                    ...
                    /\bactive/.test(n.parentNode.className) ||
                        ...
                        a.dropdown &&
                            (/\bdropdown-menu/.test(
                                a.tab.parentNode.parentNode.className
                            )
