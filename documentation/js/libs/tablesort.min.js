                ...
                if (
                    ...
                    if (a.tHead && a.tHead.rows.length > 0) {
                        for (e = 0; e < a.tHead.rows.length; e++)
                            if (
                                'thead' ===
                                a.tHead.rows[e].getAttribute('data-sort-method')
                            ) {
                                c = a.tHead.rows[e];
                                break;
                            }
                        c || (c = a.tHead.rows[a.tHead.rows.length - 1]),
                            (g.thead = !0);
                    } else c = a.rows[0];
                if (c) {
                    var h = function() {
                    ...
                    for (e = 0; e < c.cells.length; e++)
                        (f = c.cells[e]),
                            ...
                            'none' !== f.getAttribute('data-sort-method') &&
                                ...
                                null !== f.getAttribute('data-sort-default') &&
                                    (d = f));
            ...
            sortTable: function(a, g) {
                ...
                if (
                    ...
                    if (!n) {
                        for (
                            ;
                            l.length < 3 && m < h.table.tBodies[0].rows.length;
                        ...
                        if (!(h.table.tBodies[m].rows.length < 2)) {
                            for (p = 0; p < h.table.tBodies[m].rows.length; p++)
                                (k = h.table.tBodies[m].rows[p]),
                                    'none' ===
                                    k.getAttribute('data-sort-method')
                                        ? (r[s] = k)
                                        : q.push({
                                              tr: k,
                                              td: d(k.cells[h.col]),
