...
!(function() {
    ...
    function W(e) {
        ...
        if (
            (null == No &&
                (No = !('onselectstart' in e) && M(e.style, 'userSelect')),
            No)
        ) {
            var o = n(e).style,
                a = o[No];
    ...
    function Tn() {
        var n = Rn(),
            t = Dn() - n;
        t > 24
            ? (isFinite(t) && (clearTimeout(Qo), (Qo = setTimeout(Tn, t))),
              (Ko = 0))
            : ((Ko = 1), na(Tn));
    }
    function Rn() {
    ...
    function In(n) {
        ...
        function i(n, t, e) {
            ...
            return r
                ? ((n.w = _.get(r[0].toLowerCase())), e + r[0].length)
                : -1;
        }
        function u(n, t, e) {
            N.lastIndex = 0;
        ...
        return function(a) {
            function l(n) {
                for (var t = 0, e = v.length, r = n[1], i = 0; i < e; ++i)
                    for (
                        var u, o = 1, a = v[i], l = a.length, c = a[0];
                        o < l;
                        ++o
                    )
                        (u = a[o]),
    ...
    function ae(n) {
        ...
        return (
            ...
            (t.clipExtent = function(n) {
                return arguments.length
                    ? ((S = n),
                      (b = n ? Zt(n[0][0], n[0][1], n[1][0], n[1][1]) : m),
                      i())
                    : S;
            }),
            (t.scale = function(n) {
    ...
    function de(n, t) {
        ...
        return function(i, u, o, a) {
            ...
            for (var c, f = i; o > 0 ? f > u : f < u; f -= l)
                a.point(
                    (c = bt([e, -r * Math.cos(f), -r * Math.sin(f)]))[0],
                    c[1]
                );
        };
    }
    ...
    function ar(n, t) {
        var e,
            ...
            u = n.sort(lr).pop();
        for (
            Ba = [], Wa = new Array(n.length), Ja = new er(), Ka = new er();
            ;

        )
            if (
                ((i = Ga), u && (!i || u.y < i.y || (u.y === i.y && u.x < i.x)))
            )
                (u.x === e && u.y === r) ||
    ...
    function zr(n, t) {
        ...
        return (
            ...
            function(r) {
                return (
                    1 + n * Math.pow(2, -10 * r) * Math.sin(((r - e) * qo) / t)
                );
            }
        );
    }
    ...
    function Gi(n, t, e, r) {
        function i(n) {
            return (
                (e ? Math.log(n < 0 ? 0 : n) : -Math.log(n > 0 ? 0 : -n)) /
                Math.log(t)
            );
        }
        function u(n) {
    ...
    function Mu(n, t) {
        return n.length < 3
            ...
            : n[0] +
                  bu(
                      (n.push(n[0]), n),
                      wu([n[n.length - 2]].concat(n, [n[1]]), t)
                  );
    }
    function _u(n, t) {
    ...
    function qu(n) {
        for (
            var t, e, r, i, u = [], o = Lu(n), a = -1, l = n.length - 1;
            ++a < l;
    ...
    function no(n) {
        ...
        return (
            t.selectNode(io.body), t.createContextualFragment(n.responseText)
        );
    }
        ...
        (_o.selectAll = function(n) {
            ...
            for (var i = -1, u = this.length; ++i < u; )
                for (var o = this[i], a = -1, l = o.length; ++a < l; )
                    (e = o[a]) &&
                        (r.push((t = ro(n.call(e, e.__data__, a, i)))),
                        (t.parentNode = e));
            return E(r);
        });
            ...
            function e(n, t, e, u, o) {
                return function() {
                    ...
                    var c,
                        f = this,
                        s =
                            to.event.target.correspondingElement ||
                            to.event.target,
                        h = f.parentNode,
                        p = r.of(f, arguments),
                        g = 0,
            ...
            function h() {
                ...
                function t() {
                    ...
                    to
                        ...
                        b.push(t);
                    for (
                        var e = to.event.changedTouches, i = 0, u = e.length;
                        i < u;
                        ++i
                    )
        ...
        [
            ...
            var e = (ia[n] = On(
                ...
                function(n) {
                    ...
                    return (
                        Math.floor((ia.dayOfYear(n) + ((e + t) % 7)) / 7) -
                        (e !== t)
                    );
                }
            ));
    ...
    (to.geo.path = function() {
        ...
        (to.geo.rotation = function(n) {
            function t(t) {
                return (
                    (t = n(t[0] * Do, t[1] * Do)), (t[0] *= Po), (t[1] *= Po), t
                );
            }
            return (
                (n = se(
            ...
            return (
                (l.tick = function() {
                    ...
                    for (r = 0; r < w; ++r)
                        (h = (l = M[r]).source),
                            (d =
                                (m = (p = l.target).x - h.x) * m +
                                (_ = p.y - h.y) * _) &&
                                ((m *= d =
                                    (i * o[r] * ((d = Math.sqrt(d)) - u[r])) /
                                    d),
                                (_ *= d),
                                (p.x -=
                                    m *
                    ...
                    if (g)
                        for (
                            ei((t = to.geom.quadtree(x)), i, a), r = -1;
                            ++r < b;
                ...
                (l.start = function() {
                    ...
                    var t,
                        ...
                        d = f[1];
                    for (t = 0; t < i; ++t)
                        ((r = x[t]).index = t), (r.weight = 0);
                    for (t = 0; t < c; ++t)
                        'number' == typeof (r = M[t]).source &&
                            (r.source = x[r.source]),
    ...
    to.layout.stack = function() {
        function n(a, l) {
            ...
            for (g = 0; g < y; ++g)
                for (
                    i.call(n, c[0][g], (d = v[g]), f[0][g][1]), p = 1;
                    p < h;
                    ++p
                )
    ...
    (to.layout.histogram = function() {
        ...
        (to.layout.tree = function() {
            ...
            function o(n, t, e) {
                for (
                    ...
                    null != _
                        ...
                        : null != b &&
                          (p += r.x_size / 2 + u.x_size / 2 + b(r.t, u.t)),
                        p > 0
                            ? ((o += p), a(n, t, e.index, p))
                            : 1 === t &&
                              0 === o &&
            ...
            function c(n) {
                return 0 == n.num_children
                    ? n.tr
                    : n.children[n.num_children - 1];
            }
            function f(n) {
                        ...
                        f.push((o = h[l - 1])),
                            ...
                            'squarify' !== p || (a = r(f, d)) <= g
                                ...
                                : ((f.area -= f.pop().area),
                                  ...
                                  (f.length = f.area = 0),
                                  (g = 1 / 0));
                    f.length && (i(f, d, c, !0), (f.length = f.area = 0)),
                        u.forEach(t);
                }
            }
            function e(t) {
    ...
    (Tl.call = _o.call),
        ...
        (Tl.styleTween = function(n, e, r) {
            ...
            return (
                arguments.length < 3 && (r = ''), this.tween('style.' + n, i)
            );
        }),
        (Tl.text = function(n) {
        ...
        (Tl.each = function(n, t) {
            ...
            if (arguments.length < 2) {
                ...
                I(this, function(i) {
                    ...
                    (
                        u.event ||
                        (u.event = to.dispatch('start', 'end', 'interrupt'))
                    ).on(n, t);
                });
            return this;
        }),
