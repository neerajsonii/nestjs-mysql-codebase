...
!(function(t, e) {
                ...
                for (; a.nextNode(); ) {
                    ...
                    if (1 === _e3.nodeType) {
                        ...
                        if (_t2.indexOf(l) >= 0) {
                            ...
                            for (var _t3 = 0; _t3 < _a2; _t3++) {
                                _o3.insertBefore(
                                    '' === _r2[_t3]
                                        ? m()
                                        : document.createTextNode(_r2[_t3]),
                                    _e3
                                ),
                                    _this.parts.push({
                                        type: 'node',
                        ...
                        if (_e3.data === l) {
                            ...
                            for (
                                ;
                                -1 !== (_t5 = _e3.data.indexOf(l, _t5 + 1));
        ...
        _createClass(v, [
            {
                ...
                value: function update(t) {
                    ...
                    try {
                        for (
                            var _iterator = this._parts[Symbol.iterator](),
                                _step;
                    ...
                    try {
                        for (
                            var _iterator2 = this._parts[Symbol.iterator](),
                                _step2;
            ...
            },
            {
                ...
                value: function _clone() {
                    ...
                    return (
                        o(t),
                        i && (document.adoptNode(t), customElements.upgrade(t)),
                        t
                    );
                },
            },
    ...
    var _ = function _(t) {
        return (
            null === t || !('object' == _typeof(t) || 'function' == typeof t)
        );
    };
    var y = (function() {
        function y(t, e, s) {
        ...
        _createClass(V, [
            ...
            },
            {
                ...
                value: function _commitNode(t) {
                    this.value !== t &&
                        (this.clear(), this._insert(t), (this.value = t));
                },
            },
            {
                key: '_commitText',
            ...
            },
            {
                ...
                value: function _commitIterable(t) {
                    ...
                    try {
                        for (
                            ...
                            void 0 === (s = e[i]) &&
                                ...
                                e.push(s),
                                0 === i
                                    ? s.appendIntoPart(this)
                                    : s.insertAfterPart(e[i - 1])),
                                s.setValue(_n3),
                                s.commit(),
                                i++;
                        }
                    ...
                    i < e.length &&
                        ((e.length = i), this.clear(s && s.endNode));
                },
            },
            {
                key: 'clear',
