        ...
        2: [
            function(t, e, o) {
                ...
                e.exports = {
                    ...
                    disable: function(t) {
                        t.controlIcons &&
                            (t.controlIcons.parentNode.removeChild(
                                t.controlIcons
                            ),
                            (t.controlIcons = null));
                    },
                ...
                (l.prototype.init = function(t, e) {
                    ...
                    (l.prototype.setupHandlers = function() {
                        ...
                        if (
                            ...
                            var o = this.options.customEventsHandler
                                .haltEventListeners;
                            if (o && o.length)
                        ...
                        if (this.options.zoomEnabled && 'none' === this.state) {
                            ...
                            (this.lastMouseWheelEventTime = Date.now()),
                                'deltaMode' in t &&
                                    ...
                                    (e =
                                        0 === t.deltaY
                                            ? 0
                                            : Math.abs(t.wheelDelta) /
                                              t.deltaY),
                                (e =
                                    -0.3 < e && e < 0.3
                                        ? e
                                        : ((e > 0 ? 1 : -1) *
                                              Math.log(Math.abs(e) + 10)) /
                                          n);
                            var i = this.svg.getScreenCTM().inverse(),
                                s = r
                                    ...
                                    .matrixTransform(i),
                                a = Math.pow(
                                    1 + this.options.zoomScaleSensitivity,
                                    -1 * e
                                );
                    ...
                    (l.prototype.center = function() {
                        var t = this.viewport.getViewBox(),
                            e =
                                0.5 *
                                (this.width -
                                    (t.width + 2 * t.x) * this.getZoom()),
                            o =
                                0.5 *
                                (this.height -
                                    (t.height + 2 * t.y) * this.getZoom());
                        ...
                        return (
                            this.publicInstance ||
                                (this.publicInstance = this.pi = {
                                    enablePan: function() {
                                        return (
                                            (t.options.panEnabled = !0), t.pi
                                        );
                                    },
                                    disablePan: function() {
                                        return (
                                            (t.options.panEnabled = !1), t.pi
                                        );
                                    },
                                    ...
                                    enableZoom: function() {
                                        return (
                                            (t.options.zoomEnabled = !0), t.pi
                                        );
                                    },
                                    disableZoom: function() {
                                        return (
                                            (t.options.zoomEnabled = !1), t.pi
                                        );
                                    },
                                    ...
                                    enableControlIcons: function() {
                                        return (
                                            t.options.controlIconsEnabled ||
                                                ((t.options.controlIconsEnabled = !0),
                                                i.enable(t)),
                                            t.pi
                                        );
                                    },
                                    ...
                                    enableDblClickZoom: function() {
                                        return (
                                            (t.options.dblClickZoomEnabled = !0),
                                            t.pi
                                        );
                                    },
                                    disableDblClickZoom: function() {
                                        return (
                                            (t.options.dblClickZoomEnabled = !1),
                                            t.pi
                                        );
                                    },
                                    ...
                                    setZoomScaleSensitivity: function(e) {
                                        return (
                                            (t.options.zoomScaleSensitivity = e),
                                            t.pi
                                        );
                                    },
                                    ...
                                    zoomAtPoint: function(e, o) {
                                        return (
                                            t.publicZoomAtPoint(e, o, !0), t.pi
                                        );
                                    },
                                    zoomAtPointBy: function(e, o) {
                                        return (
                                            t.publicZoomAtPoint(e, o, !1), t.pi
                                        );
                                    },
                                    zoomIn: function() {
                                        return (
                ...
                var c = [],
                    p = function(t, e) {
                        ...
                        for (var n = c.length - 1; n >= 0; n--)
                            if (c[n].svg === o)
                                return c[n].instance.getPublicInstance();
                        return (
                ...
                document.documentMode && (i = 'ie'),
                    (e.exports = {
                        ...
                        getBoundingClientRectNormalized: function(t) {
                            ...
                            throw new Error(
                                'Cannot get BoundingClientRect for SVG.'
                            );
                        },
                        getOrCreateViewport: function(t, e) {
                            var o = null;
                            if (
                                ((o = n.isElement(e) ? e : t.querySelector(e)),
                                !o)
                            ) {
            ...
            function(t, e, o) {
                e.exports = (function() {
                    function t(t, e) {
                        var o = function(t) {
                            ...
                            var o = {
                                ...
                                type: 'wheel',
                                deltaMode:
                                    'MozMousePixelScroll' == t.type ? 0 : 1,
                                deltaX: 0,
                                delatZ: 0,
                    ...
                    function s(t, e, o) {
                        n(t, u, e, o),
                            'DOMMouseScroll' == u &&
                                n(t, 'MozMousePixelScroll', e, o);
                    }
                    function r(t, e, o) {
                        i(t, u, e, o),
                            'DOMMouseScroll' == u &&
                                i(t, 'MozMousePixelScroll', e, o);
                    }
                    var a,
                        l,
                        u,
                    ...
                    createRequestAnimationFrame: function(t) {
                        ...
                        return (
                            'auto' !== t &&
                                ...
                                (e = Math.floor(1e3 / t)),
                            null === e
                                ? window.requestAnimationFrame || n(33)
                                : n(e)
                        );
                    },
                };
