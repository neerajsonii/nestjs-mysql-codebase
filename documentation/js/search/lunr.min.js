...
!(function() {
    ...
    (e.version = '2.3.6'),
        ...
        (e.Pipeline.load = function(t) {
            ...
            return (
                t.forEach(function(t) {
                    ...
                    if (!i)
                        throw new Error(
                            'Cannot load unregistered function: ' + t
                        );
                    r.add(i);
                }),
                r
        ...
        (e.TokenSet.fromArray = function(t) {
            for (
                var r = new e.TokenSet.Builder(), i = 0, n = t.length;
                i < n;
                i++
            )
                r.insert(t[i]);
        ...
        (e.TokenSet.fromString = function(t) {
            for (
                var r = new e.TokenSet(), i = r, n = 0, s = t.length;
                n < s;
                n++
            ) {
                var o = t[n],
                ...
                for (var s = 0; s < n.length; s++) {
                    ...
                    for (var u = 0; u < a.length; u++) {
                        ...
                        void 0 == this.metadata[i][o][l]
                            ...
                            : (this.metadata[i][o][l] = this.metadata[i][o][
                                  l
                              ].concat(e.metadata[i][o][l]));
                    }
                }
            }
        }),
        ...
        (e.QueryLexer.lexText = function(t) {
            for (;;) {
                ...
                if (92 != r.charCodeAt(0)) {
                    ...
                    if ('+' == r && 1 === t.width())
                        return (
                            t.emit(e.QueryLexer.PRESENCE), e.QueryLexer.lexText
                        );
                    if ('-' == r && 1 === t.width())
                        return (
                            t.emit(e.QueryLexer.PRESENCE), e.QueryLexer.lexText
        ...
        (e.QueryParser.parsePresence = function(t) {
            ...
            if (void 0 != r) {
                ...
                switch (n.type) {
                    ...
                    default:
                        var i =
                            "expecting term or field, found '" + n.type + "'";
